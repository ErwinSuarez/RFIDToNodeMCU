/* This is using NodeMCU to connect to RFID-RC522 with pin connections indicated below
 * This will also display RFID tag's UID and indicate If a tag is being scanned and 
 * another indicator if there is an error while scanning
   ------------------------------------------------------
